...
public class EmployeeController {
	...
	public ResponseEntity<SalaryAccount> allocateBank(@RequestParam long bankAccountNumber,@RequestParam Bank bank)
	{
		return ResponseEntity.ok(employeeservice.allocateBank(bankAccountNumber, bank));
	}
	
	@PutMapping("/salaryaccount/transaction")
	public ResponseEntity<SalaryAccount> allocateTransactions(@RequestParam long accountNumber,@RequestBody List<SalaryTransaction> transactions)
	{
		return ResponseEntity.ok(employeeservice.allocateTransactions(accountNumber,transactions));
	}
